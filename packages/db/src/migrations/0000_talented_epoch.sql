...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "audit_log_org_id_idx" ON "audit_log" USING btree ("organization_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX IF NOT EXISTS "memberships_user_org_uidx" ON "memberships" USING btree ("user_id","organization_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "memberships_user_id_idx" ON "memberships" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "memberships_org_id_idx" ON "memberships" USING btree ("organization_id");--> statement-breakpoint
