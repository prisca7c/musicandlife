...
async function seed() {
  ...
  const teacherDefs = [
    ...
    { firstName: 'James', lastName: 'Carter',   instruments: ['guitar', 'bass guitar', 'drums'],  hourlyRate: 4000 },
  ...
  // ── Families & students ───────────────────────────────────────────────────────
  const familyDefs = [
    { name: 'Claire Johnson', contactName: 'Claire Johnson', email: 'claire@example.com', phone: '07700 900001', students: [
    ...
    { name: 'David Smith', contactName: 'David Smith', email: 'david@example.com', phone: '07700 900002', students: [
    ...
    { name: 'Priya Patel', contactName: 'Priya Patel', email: 'priya@example.com', phone: '07700 900003', students: [
    ...
    { name: 'Tom Williams', contactName: 'Tom Williams', email: 'tom@example.com', phone: '07700 900004', students: [
      { firstName: 'Sophia', lastName: 'Williams', dob: '2010-04-12', instrument: 'cello', teacherId: meiId },
    ]},
    { name: 'Rachel Brown', contactName: 'Rachel Brown', email: 'rachel@example.com', phone: '07700 900005', students: [
